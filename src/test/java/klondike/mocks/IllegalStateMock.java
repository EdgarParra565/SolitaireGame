...
/**
 * Mock class to test controller that throws IllegalState.
 * Only going to use moveDraw.
 */
public class IllegalStateMock implements KlondikeModel<Card> {
   ...
   *                                  the same, or there are not enough cards to move from
   *                                  the srcPile to the
